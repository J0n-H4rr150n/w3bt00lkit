...
class SynackTargetModel(Base): # pylint: disable=R0903
    ...
    target_codename = Column(String, unique=True, index=True)
    target_org_id = Column(String)
    target_name = Column(String)
    activated_at = Column(BigInteger)
    category = Column(String)
    outage_windows = Column(String)
    vulnerability_discovery = Column(Boolean)
    collaboration_criteria = Column(String)
